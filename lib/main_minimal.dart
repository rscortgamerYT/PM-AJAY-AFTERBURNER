...
import 'dashboards/enhanced_centre_dashboard.dart';
import 'dashboards/state_dashboard.dart';
import 'dashboards/agency_dashboard.dart';
import 'dashboards/public_dashboard.dart';

void main() {
  runApp(const PMAjayMinimalApp());
}

class PMAjayMinimalApp extends StatelessWidget {
  const PMAjayMinimalApp({super.key});
...
class HomePage extends StatelessWidget {
            ...
            Container(
              ...
              child: const Column(
                children: [
                  ...
                  SizedBox(height: 4),
                  Text(
                    'This is a simplified demo version of the PM-AJAY platform. Click on any role card above to explore the features.',
  ...
  Widget _buildRoleCard(BuildContext context, String title, IconData icon, Color color, String description) {
    return Card(
      ...
      child: InkWell(
        onTap: () => _showRoleInfo(context, title, description),
        borderRadius: BorderRadius.circular(12),
        child: Padding(
          padding: const EdgeInsets.all(16),
          child: Column(
  ...
  void _showRoleInfo(BuildContext context, String role, String description) {
    showDialog(
      context: context,
        ...
        return AlertDialog(
          ...
          content: Column(
            ...
            children: [
              ...
              const SizedBox(height: 16),
              const Text(
                'Features available in this role:',
                style: TextStyle(fontWeight: FontWeight.bold),
              ),
              const SizedBox(height: 8),
              Text(_getRoleFeatures(role)),
            ],
          ),
          actions: [
            TextButton(
  ...
  void _navigateToRoleDashboard(BuildContext context, String role) {
    ...
    switch (role) {
      ...
      case 'Communication Hub':
        dashboard = const CentreDashboard(); // Using centre dashboard for communication hub
        break;
      default:
  ...
  String _getRoleFeatures(String role) {
    switch (role) {
      case 'Centre Admin':
        return '• Nationwide project oversight\n• Fund allocation management\n• State coordination\n• Policy implementation';
      case 'State Officer':
        return '• State-level project management\n• District coordination\n• Fund utilization tracking\n• Progress reporting';
      case 'Agency User':
